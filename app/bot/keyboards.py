...
class AdminMenuAction(StrEnum):
    ...
    WORKING_TIME_DATE = "working_date"
    WORKING_TIME_CONFIRM = "working_confirm"
    WORKING_TIME_APPLY = "working_apply"
    MANUAL_BOOKING_CLIENT = "mb_client"
    MANUAL_BOOKING_SERVICE = "mb_service"
    MANUAL_BOOKING_DURATION = "mb_duration"
    MANUAL_BOOKING_DATE = "mb_date"
    MANUAL_BOOKING_SLOT = "mb_slot"
    CONFIRM_MANUAL_BOOKING = "mb_confirm"
